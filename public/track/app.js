...
}).setView([48.861920, 2.341755], 12);
*/

/*
mapboxgl.accessToken = 'pk.eyJ1Ijoid2Vic3RlcnNvbHV0aW9ucyIsImEiOiJjaXc0bGQ0dHowMDA1Mm9vOXlqM2tzcDRoIn0.s0uVlfOpvNJWXdHPIEFEQg';
...
function addPoint(uuid, point) {
  var marker = L.marker([point.coords.latitude, point.coords.longitude], {
